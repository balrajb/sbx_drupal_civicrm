...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://balraj:rockin@192.168.184.1/sbx_drupal_civicrm?new_link=true' );
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://balraj:rockin@192.168.184.1/sbx_drupal_civicrm_crm?new_link=true' );
}
...
$civicrm_root = '/var/www/html/sbx_drupal_civicrm/sites/all/modules/contrib/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/html/sbx_drupal_civicrm/sites/default/files/civicrm/templates_c/' );
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://local.drupal-civicrm.com:8080/' );
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '0112abcda8a9f0764f0705124a4ee26b' );
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/html/sbx_drupal_civicrm/sites/default/files/civicrm/templates_c//mail.log' );
// }
